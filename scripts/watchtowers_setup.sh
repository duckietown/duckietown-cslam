...
do
    printf "\nSetting up %s\n" ${array[$index]}
    docker -H ${array[$index]}.local start roscore
    docker -H ${array[$index]}.local start ros-picam
