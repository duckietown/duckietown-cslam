...
"""autogenerated by genpy from duckietown_msgs/AprilTagExtended.msg. Do not edit."""
import sys
...
class AprilTagExtended(genpy.Message):
  _md5sum = "1ca0d2f82762ea5d7ea60150ab894e3f"
  _type = "duckietown_msgs/AprilTagExtended"
...
float64 w
"""
  __slots__ = ['header','transform','tag_id','tag_family','hamming','decision_margin','homography','center','corners','pose_error']
  _slot_types = ['std_msgs/Header','geometry_msgs/Transform','int32','string','int32','float32','float32[9]','float32[2]','float32[8]','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,transform,tag_id,tag_family,hamming,decision_margin,homography,center,corners,pose_error
    ...
    """
    if args or kwds:
      super(AprilTagExtended, self).__init__(*args, **kwds)
